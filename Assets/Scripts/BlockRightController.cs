...
{
    private readonly String[] unpassableBlocksTags = {"Wall", "Lock", "block", "UpOnly", "DownOnly", "LeftOnly", "LevelWall"};
    ...
    void Update()
    {
        if (Swipe.SwipeLeft && playerTouch && playerMovement.Movable && antiBlock.CheckMovement())
        {
